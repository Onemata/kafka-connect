...
4. Point your browser to: http://localhost:8083/ and you should see something similar to ![Screenshot 1](https://github.com/Onemata/kafka-connect/raw/master/screenshot1.png)
